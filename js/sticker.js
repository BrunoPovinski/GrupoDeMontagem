...
var c = {
  init: function p(t) {
    ...
    var C, z = t.getBoundingClientRect(),
      F = z.width,
      x = F >> 2,
      q = g("div", {
        position: "relative",
    ...
    t.addEventListener("mouseenter", function(G) {
      f(G, C)
    }, false);
    t.addEventListener("mouseleave", function(G) {
      l(G, C)
    }, false);
    t.addEventListener("mousemove", function(G) {
      a(G, C)
    }, false);
    return this
  }
